 ...
 */
package com.example.sb.purchase.schema;
...
public class NewPurchase extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7383718017171147108L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewPurchase\",\"namespace\":\"com.example.sb.purchase.schema\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"clientId\",\"type\":\"string\"}]}");
   ...
   */
  public NewPurchase(java.lang.CharSequence id, java.lang.CharSequence clientId) {
    this.id = id;
   ...
   */
  public static com.example.sb.purchase.schema.NewPurchase.Builder newBuilder() {
    return new com.example.sb.purchase.schema.NewPurchase.Builder();
  }
   ...
   * @return A new NewPurchase RecordBuilder
   */
  public static com.example.sb.purchase.schema.NewPurchase.Builder newBuilder(com.example.sb.purchase.schema.NewPurchase.Builder other) {
    if (other == null) {
      return new com.example.sb.purchase.schema.NewPurchase.Builder();
    } else {
      return new com.example.sb.purchase.schema.NewPurchase.Builder(other);
    }
  }
   ...
   * @return A new NewPurchase RecordBuilder
   */
  public static com.example.sb.purchase.schema.NewPurchase.Builder newBuilder(com.example.sb.purchase.schema.NewPurchase other) {
    if (other == null) {
      return new com.example.sb.purchase.schema.NewPurchase.Builder();
    } else {
      return new com.example.sb.purchase.schema.NewPurchase.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewPurchase>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.sb.purchase.schema.NewPurchase.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.sb.purchase.schema.NewPurchase other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.sb.purchase.schema.NewPurchase.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.sb.purchase.schema.NewPurchase.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.sb.purchase.schema.NewPurchase.Builder setClientId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.sb.purchase.schema.NewPurchase.Builder clearClientId() {
      clientId = null;
